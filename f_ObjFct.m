function s = f_ObjFct(x,M,mat_HOS,SNR,Nt,lMC)
...
mat_HOS_cptNt=repmat(x',1,lSNR*lMMC).*mat_HOS([1 3 5 6 8 10 12 14 15 16 17 18 19 20 21],:,cptNt); % HOS
...
%stat(3+Nt,:)=round(sum(repmat(x',1,lSNR*lMMC).*stat(3:2+Nt,:)));
end
